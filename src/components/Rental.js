...
const Rental = ({ title, image, price, aminities, date }) => {
  return (
    <div className="">
      ...
      <div className="pt-3 flex justify-between items-start">
        ...
        <div className="">
          ...
          <p className="max-w-[17rem]  text-[16px] -mt-1 text-gray-500">{date}
          </p>
          <p className="max-w-[17rem] font-semibold text-[17px]">Rs.{price}</p>
          <p className="max-w-[17rem]  text-[16px] -mt-1 text-gray-500">{aminities}
          </p>
        </div>
        {/* Right */}
